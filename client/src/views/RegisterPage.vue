                        ...
                        <div class="py-2 px-4 text-lg leading-6 space-y-4 text-gray-200">
                            ...
                            <div class="relative">
                                ...
                                <label for="confirmPassword"
                                    class="cursor-pointer absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Confirm Password</label>
                            </div>
                            <div class="relative">
